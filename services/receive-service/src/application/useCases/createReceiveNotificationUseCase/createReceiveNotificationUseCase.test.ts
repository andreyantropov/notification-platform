...
describe("ReceiveNotificationBatchUseCase", () => {
  ...
  describe("notify", () => {
    it("should enrich and dispatch a single notification", async () => {
      mockEnrichmentService.enrich.mockReturnValue(mockNotification);
      mockDispatchService.dispatch.mockResolvedValue(undefined);
    ...
    it("should propagate errors from dispatch service", async () => {
      mockEnrichmentService.enrich.mockReturnValue(mockNotification);
      mockDispatchService.dispatch.mockRejectedValue(
