import { CHANNEL_TYPE, type Contact } from "@notification-platform/core";
import { SPAN_KIND, type Tracer } from "@notification-platform/telemetry";
import { beforeEach, describe, expect, it, vi } from "vitest";

import { type Channel } from "../../../../domain/ports/index.js";

import { type TracingDependencies } from "./interfaces/index.js";
import { withTracing } from "./withTracing.js";

describe("withTracing (Channel)", () => {
